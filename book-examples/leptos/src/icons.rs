    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <BanknoteCheck /> }.into_any(), "Banknote Check"),
                ...
                (view! { <BeefOff /> }.into_any(), "Beef Off"),
                ...
                (view! { <BookBookmark /> }.into_any(), "Book Bookmark"),
    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <BriefcasePlus /> }.into_any(), "Briefcase Plus"),
                ...
                (view! { <BuildingComplex /> }.into_any(), "Building Complex"),
                (view! { <BuildingComplexPlus /> }.into_any(), "Building Complex Plus"),
    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <CalendarChevronsRight /> }.into_any(), "Calendar Chevrons Right"),
                ...
                (view! { <CctvOff /> }.into_any(), "Cctv Off"),
    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <ClockArrowLeft /> }.into_any(), "Clock Arrow Left"),
                (view! { <ClockArrowRight /> }.into_any(), "Clock Arrow Right"),
    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <GlobeCode /> }.into_any(), "Globe Code"),
    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <HourglassCog /> }.into_any(), "Hourglass Cog"),
                (view! { <House /> }.into_any(), "House"),
                (view! { <HouseCog /> }.into_any(), "House Cog"),
    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <LayersArrowDown /> }.into_any(), "Layers Arrow Down"),
                (view! { <LayersArrowUp /> }.into_any(), "Layers Arrow Up"),
                (view! { <LayersMinus /> }.into_any(), "Layers Minus"),
                (view! { <LayersPlus /> }.into_any(), "Layers Plus"),
                (view! { <LayoutArrowDown /> }.into_any(), "Layout Arrow Down"),
                (view! { <LayoutArrowRight /> }.into_any(), "Layout Arrow Right"),
                ...
                (view! { <Lighthouse /> }.into_any(), "Lighthouse"),
                (view! { <LineDotBottomVertical /> }.into_any(), "Line Dot Bottom Vertical"),
                (view! { <LineDotLeftHorizontal /> }.into_any(), "Line Dot Left Horizontal"),
                (view! { <LineDotRightHorizontal /> }.into_any(), "Line Dot Right Horizontal"),
                (view! { <LineDotTopVertical /> }.into_any(), "Line Dot Top Vertical"),
                (view! { <LineSquiggle /> }.into_any(), "Line Squiggle"),
                (view! { <LineStyle /> }.into_any(), "Line Style"),
    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <Mouth /> }.into_any(), "Mouth"),
                (view! { <MouthOff /> }.into_any(), "Mouth Off"),
    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <NepaliRupee /> }.into_any(), "Nepali Rupee"),
                ...
                (view! { <NotebookDot /> }.into_any(), "Notebook Dot"),
    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <PencilSparkles /> }.into_any(), "Pencil Sparkles"),
                ...
                (view! { <PlantPot /> }.into_any(), "Plant Pot"),
    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <RotateCcwClock /> }.into_any(), "Rotate Ccw Clock"),
                (view! { <RotateCcwKey /> }.into_any(), "Rotate Ccw Key"),
                (view! { <RotateCcwSquare /> }.into_any(), "Rotate Ccw Square"),
                (view! { <RotateCw /> }.into_any(), "Rotate Cw"),
                (view! { <RotateCwClock /> }.into_any(), "Rotate Cw Clock"),
                (view! { <RotateCwFadingClock /> }.into_any(), "Rotate Cw Fading Clock"),
    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <SaveCheck /> }.into_any(), "Save Check"),
                ...
                (view! { <ScanSquare /> }.into_any(), "Scan Square"),
                ...
                (view! { <ShipCargo /> }.into_any(), "Ship Cargo"),
                ...
                (view! { <ShoppingCartMinus /> }.into_any(), "Shopping Cart Minus"),
                (view! { <ShoppingCartPlus /> }.into_any(), "Shopping Cart Plus"),
                ...
                (view! { <ShrimpOff /> }.into_any(), "Shrimp Off"),
    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <SquareBookmark /> }.into_any(), "Square Bookmark"),
                (
                ...
                (view! { <SquareDashedPlus /> }.into_any(), "Square Dashed Plus"),
                (view! { <SquareDashedText /> }.into_any(), "Square Dashed Text"),
                (view! { <SquareDashedTopSolid /> }.into_any(), "Square Dashed Top Solid"),
                (view! { <SquareDashedX /> }.into_any(), "Square Dashed X"),
                (view! { <SquareDashedXCorner /> }.into_any(), "Square Dashed X Corner"),
                ...
                (view! { <SquareOff /> }.into_any(), "Square Off"),
    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <StickyNoteCheck /> }.into_any(), "Sticky Note Check"),
                (view! { <StickyNoteMinus /> }.into_any(), "Sticky Note Minus"),
                (view! { <StickyNoteOff /> }.into_any(), "Sticky Note Off"),
                (view! { <StickyNotePlus /> }.into_any(), "Sticky Note Plus"),
                (view! { <StickyNoteX /> }.into_any(), "Sticky Note X"),
                (view! { <StickyNotes /> }.into_any(), "Sticky Notes"),
    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <TagPlus /> }.into_any(), "Tag Plus"),
                (view! { <TagX /> }.into_any(), "Tag X"),
                ...
                (view! { <Toothbrush /> }.into_any(), "Toothbrush"),
                (view! { <ToothbrushSparkles /> }.into_any(), "Toothbrush Sparkles"),
                ...
                (
                    view! { <TrianglesCenterlineDashedHorizontal /> }.into_any(),
                    "Triangles Centerline Dashed Horizontal",
                ),
                (
                    view! { <TrianglesCenterlineDashedVertical /> }.into_any(),
    ...
    view! {
        <For
            each=move || [
                ...
                (view! { <WavesHorizontal /> }.into_any(), "Waves Horizontal"),
